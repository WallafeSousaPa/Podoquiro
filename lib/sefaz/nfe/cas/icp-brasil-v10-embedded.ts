/**
 * AC Raiz ICP-Brasil v10 (PEM). Necessária para validar TLS de serviços SEFAZ/SVRS no Node
 * (cadeia até o SERPRO SSLv1).
 *
 * Fonte pública (espelho Serpro, alinhado ao repositório ITI):
 * https://repositorio.serpro.gov.br/docs/icpbrasilv10.crt
 */
export const ICP_BRASIL_V10_RAIZ_PEM = `-----BEGIN CERTIFICATE-----
