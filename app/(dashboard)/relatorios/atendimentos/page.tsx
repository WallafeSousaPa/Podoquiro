...
import { RelatorioAtendimentosClient } from "./relatorio-atendimentos-client";
...
export default async function RelatorioAtendimentosPage() {
  ...
  if (!usuarioTemMenu(menusLiberados, "relatorios.atendimentos")) {
    redirect("/inicio");
  }
        ...
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6">
              <h1 className="m-0 text-dark">Atendimentos</h1>
            </div>
            <div className="col-sm-6">
