...
import type { UsuarioGrupo } from "@/lib/data/usuarios-grupos";
...
export function UsuariosGruposClient({ initialRows, loadError }: Props) {
  ...
  async function executarMudancaStatus() {
    ...
    setListError(null);
    try {
      const res = await fetch(`/api/usuarios-grupos/${row.id}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
      ...
      setFeedbackModal(
        ativar
          ? {
              title: "Grupo ativado",
              message: `O grupo "${row.grupo_usuarios}" foi ativado novamente e poderá ser usado em novos vínculos.`,
            }
          : {
              title: "Grupo inativado",
              message: `O grupo "${row.grupo_usuarios}" foi inativado. Ele ficará indisponível para novos vínculos.`,
            },
      );
      router.refresh();
    } finally {
    ...
    <>
      ...
      <div className="card card-outline card-primary">
        <div className="card-header d-flex flex-wrap justify-content-between align-items-center">
          <h3 className="card-title mb-2 mb-sm-0">Grupos cadastrados</h3>
          <button
            type="button"
              ...
              <form onSubmit={(e) => void handleSubmit(e)}>
                ...
                <div className="modal-body">
                  ...
                  <div className="form-group">
                    <label htmlFor="grupo-usuarios-nome">Nome do grupo</label>
                    <input
                      id="grupo-usuarios-nome"
                ...
                <p className="mb-0">
                  {confirmStatus.acao === "ativar" ? (
                    <>
                      Ativar o grupo{" "}
                      <strong>
                        &quot;{confirmStatus.row.grupo_usuarios}&quot;
                      </strong>{" "}
